...
--
-- To migrate to TimescaleDB later, see: migrations/0003_migrate_to_timescaledb.sql
--
...
CREATE TABLE IF NOT EXISTS simulation_summaries (
    ...
    -- Foreign key constraint (assuming simulation_runs table exists)
    -- If simulation_runs doesn't exist yet, you may need to create it or remove this constraint
